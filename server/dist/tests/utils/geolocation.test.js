...
describe('Geolocation Utils', () => {
    ...
    describe('getLocationFromIP', () => {
        ...
        it('should return location data from IP address', async () => {
            ...
            const result = await (0, geolocation_1.getLocationFromIP)(mockIP);
        ...
        it('should handle network errors', async () => {
            ...
            await expect((0, geolocation_1.getLocationFromIP)(mockIP))
                .rejects
    ...
    describe('getLocationFromCoords', () => {
        ...
        it('should return location data from coordinates with city', async () => {
            ...
            mockedAxios.get.mockResolvedValueOnce(mockResponse);
            const result = await (0, geolocation_1.getLocationFromCoords)(mockLat, mockLon);
            expect(mockedAxios.get).toHaveBeenCalledWith(`https://api.opencagedata.com/geocode/v1/json?q=${mockLat}+${mockLon}&key=test-api-key`);
            expect(result).toEqual({
                city: 'Mountain View',
                country: 'United States'
            });
        ...
        it('should handle missing API key', async () => {
            ...
            mockedAxios.get.mockResolvedValueOnce(mockResponse);
            const result = await (0, geolocation_1.getLocationFromCoords)(mockLat, mockLon);
            expect(mockedAxios.get).toHaveBeenCalledWith(`https://api.opencagedata.com/geocode/v1/json?q=${mockLat}+${mockLon}&key=`);
        });
        it('should handle empty results array', async () => {
            ...
            mockedAxios.get.mockResolvedValueOnce(mockResponse);
            await expect((0, geolocation_1.getLocationFromCoords)(mockLat, mockLon))
                .rejects
                .toThrow();
        });
        it('should handle network errors', async () => {
        ...
        it('should handle invalid coordinates', async () => {
            ...
            mockedAxios.get.mockRejectedValueOnce(mockError);
            await expect((0, geolocation_1.getLocationFromCoords)(invalidLat, invalidLon))
                .rejects
                .toThrow();
            expect(mockedAxios.get).toHaveBeenCalledTimes(1);
        });
