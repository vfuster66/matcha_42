...
hoistedDependencies:
  ...
  /create-jest/29.7.0(@types/node@22.10.1)(ts-node@10.9.2):
    create-jest: private
  ...
  /jest-circus/29.7.0:
    jest-circus: private
  /jest-cli/29.7.0(@types/node@22.10.1)(ts-node@10.9.2):
    jest-cli: private
  /jest-config/29.7.0(@types/node@22.10.1)(ts-node@10.9.2):
    jest-config: private
  /jest-diff/29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Mon, 02 Dec 2024 19:35:59 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /@img/sharp-win32-x64/0.33.5
  - /tslib/2.8.1
storeDir: /Users/virginie/Library/pnpm/store/v3
